...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Summarize the normalized pixel distance scores"
    )
    parser.add_argument(
        "input_csv", help="Path to the input CSV file generated by calc.py"
    )
    ...
    print("\nTotal Normalized Pixel Distance Score:")
    print("======================================")
